...
export const getInvitation = async (token: string, options?: Parameters<typeof customFetch>[1]): Promise<InvitationDetails> => {

  return customFetch<InvitationDetails>(getGetInvitationUrl(token),
  {
    ...options,
    method: 'GET'
